...
export function Cart() {
  ...
  const items: OrderItemTypes[] = Object.keys(groups).map((key) => {
    ...
    return {
      ...
      // Add subtotal if your OrderItemTypes requires it
    };
  });
  ...
  const checkoutOrder: OrderTypes = {
    ...
    status: "Processing",
    items: items, // This should NOT be empty
    totalPrice: total, // This should NOT be 0
    orderId: "", // Temporary, will be generated by backend
